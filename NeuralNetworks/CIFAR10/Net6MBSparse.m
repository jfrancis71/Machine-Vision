...
CIFARNet5={
   ...
   MaxConvolveFilterBankToFilterBank,SubsampleFilterBankToFilterBank,
   PadFilterBank[2],ConvolveFilterBankToFilterBankInit[32,64,5],Logistic,
   MaxConvolveFilterBankToFilterBank,SubsampleFilterBankToFilterBank,
   Adaptor3DTo1D[64,4,4],
   Sparse[.01,.05], (* placed after adaptor as haven't coded sparse to use multiple layers *)
...
TrainNet6MB:=MiniBatchGradientDescent[
      ...
      NNGrad,ClassificationLoss,
        {MaxEpoch->500000,
         ...
         StepMonitor->NNCheckpoint["CIFAR10\\Net6MBSparse"],
