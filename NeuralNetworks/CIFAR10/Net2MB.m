...
CIFARNet2={
   ...
   ConvolveFilterBankToFilterBank[Table[
      ...
      {f,1,32}]],Tanh,
   FilterBankToFilterBankInit[32,32],
   Tanh,
...
FilterBankToFilterBankInit[noFromLayers_,noToLayers_]:=
   FilterBankToFilterBank[Table[0.,{noToLayers}],Table[Random[]-.5,{noToLayers},{noFromLayers}]/Sqrt[noFromLayers]]


TrainNet2MB:=MiniBatchGradientDescent[
      ...
      NNGrad,ClassificationLoss,
        {MaxEpoch->500000,
         ...
         UpdateFunction->WebMonitor["CIFAR10\\Net2MB"],
