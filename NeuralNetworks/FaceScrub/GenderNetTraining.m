...
RawTrainingImages=Join[males,females];


RawTrainingLabels=Join[ConstantArray[1,Length[males]],ConstantArray[0,Length[females]]];
...
TrainGenderNet:=MiniBatchGradientDescent[
      ...
      NNGrad,CrossEntropyLoss,
        {MaxEpoch->500000,
         ...
         StepMonitor->NNCheckpoint["FaceScrub\\GenderNet"],
